...
HELP = (
    ...
    "Поэтому мост нарочно не показывает тебя в сети — иначе ты был бы онлайн вечно, "
    "даже ночью. Нужно наоборот — впиши <code>MAX_SHOW_ONLINE=да</code> в настройки.\n"
    "<code>/hidden on</code> — про другое: тогда «был в сети» не увидят вовсе.\n\n"
