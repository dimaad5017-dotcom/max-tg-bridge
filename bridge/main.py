...
async def on_tg_message(tg_message: TgMessage) -> None:
    ...
    if outgoing is None and COMMAND_SHAPE.match(text):
        ...
        await tg_message.reply(
            "<b>Не отправлено.</b> Похоже на команду, а такой у моста нет — "
            "собеседнику она ушла бы простым текстом.\n"
            "Все команды — <code>/help</code>. А если это правда сообщение, "
            "поставь перед косой чертой пробел."
        )
        return
