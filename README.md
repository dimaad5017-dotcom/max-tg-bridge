...
> [«Установка на Windows»](#установка-на-windows) или
> [«Установка на Mac и Linux»](#установка-на-mac-и-linux). Если
...
- [Установка на Mac и Linux](#установка-на-mac-и-linux)
...
Всё делается двойными кликами, консоль открывать не надо. Для Mac и Linux —
[следующий раздел](#установка-на-mac-и-linux).
...
### 2а.3. Четыре шага по порядку

```bash
bash mac-linux/1-install.sh     # окружение и библиотеки
bash mac-linux/2-settings.sh    # откроется .env — заполни как в пункте 2.4
...
### 2а.4. Автозапуск на macOS (по желанию)
...
описана в [следующем разделе](#установка-на-vps), пункт 3.5.
