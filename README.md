...
- **Ответить** → просто пиши в нужной теме. Именно в теме: из общей части группы
  в MAX ничего не уходит, там мост только отвечает на команды. Напишешь мимо —
  он про это скажет, а не проглотит молча.
