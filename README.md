...
- **Голосового и кружка в родном виде** — они доезжают, но выглядят в MAX иначе:
  ...
  и слушаются, просто без круглой рамки и волны. Так вышло не от лени: MAX не
  присылает библиотеке сигнал о готовности голосового, и она минуту ждёт впустую,
  а кружок отправляется раньше, чем MAX успевает его дожать. Когда починят на той
  стороне — вернём.
