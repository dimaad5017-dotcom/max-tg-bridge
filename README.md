...
- **Цветной кружок перед именем** → в групповом чате у каждого человека свой. Все
  ...
  ещё до того, как прочитаешь имена. Цвет держится за номером в MAX, так что не
  меняется ни от переименования, ни от перезапуска. Кружков два десятка, и в
  большом чате двое могут получить одинаковый — имя рядом всё равно написано.
  В личной теме кружка нет: там и так один человек.
