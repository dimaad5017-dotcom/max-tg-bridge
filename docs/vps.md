...
Перед этим нужно пройти [шаг 1 — бот и группа в Telegram](../README.md#шаг-1-бот-и-группа-в-telegram).
...
Что писать в `.env` — разобрано в [«Настройки»](../README.md#настройки).
